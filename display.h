...
// Helper screens are declared up front because the public wrappers below call
// helpers that are defined later in this header.
void head();
void withCard();
void withoutCard();
void printMainMenu1();
...
void printBalanceInquiry1(Account waw){ // Done
    std::cout << "|      +-----------------------------------------+      |" << std::endl;
    std::cout << "|      |             BALANCE INQUIRY             |      |" << std::endl;
    std::cout << "|      |                                         |      |" << std::endl;
    std::cout << "|  [ ] |                                         | [ ]  |" << std::endl;
...
void printFundTransferMenu1(){ // Done!
    std::cout << "|      +-----------------------------------------+      |" << std::endl;
